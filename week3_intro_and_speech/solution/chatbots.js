...
// Exercise (2): adapting Pico behaviour and adding new subscriber for 'emotional_state_change' topic
...
// Exercise (1): a single subscriber for 'speech_event'
...
// Exercise (3): remove adaptations for exercise (2) by unsubscribing
// to solve exercise (3), just unsubscribe to bitEmotionalStateListener
// uncomment the line below to test the effect of this change
// manager.unsubscribe(bitEmotionalStateListener)